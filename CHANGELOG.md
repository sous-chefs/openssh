...
## [2.11.18](https://github.com/sous-chefs/openssh/compare/2.11.17...v2.11.18) (2025-10-15)
...
* sshd_config template needs ordering
* ssh fails to start in Ubuntu 13.10
* Add support for Match block
...
* Add FreeBSD support
* Add hash support
* Make mode of sshd_config a configurable option

### Bug

* Fix RSA Server Config Options
* Fix PubkeyAuthentication option

## v1.2.2

### Bug

* Fix error setting Dynamic `ListenAddresses`
