...
default['openssh']['client']['use_roaming'] = 'no' unless (node['platform_family'] == 'rhel' && node['platform_version'].to_i < 7) || node['platform_family'] == 'suse' && node['platform_version'].to_i >= 15 && node['platform_version'].to_i < 42
